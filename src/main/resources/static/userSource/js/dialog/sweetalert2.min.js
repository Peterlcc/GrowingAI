!function (e, t) {
        ...
        return new Promise(function (n, i) {
            ...
            function s(t) {
                ...
                if (-1 !== [9, 13, 32, 27].indexOf(r)) {
                    for (var l = n.target || n.srcElement, s = x(e.focusCancel), c = -1, u = 0; u < s.length; u++) if (l === s[u]) {
                        c = u;
                        break
                    }
            ...
            var d, f = function (t) {
                ...
                var n = t || window.event, r = n.target || n.srcElement, a = C(), l = k(), s = a === r || a.contains(r),
                    c = l === r || l.contains(r);
                switch (n.type) {
                    case"mouseover":
                    case"mouseup":
                    ...
                    case"click":
                        ...
                        } else f(!0); else c && o.isVisible() && (o.closeModal(e.onClose), i("cancel"))
                }
            }, g = t.querySelectorAll("button");
            for (d = 0; d < g.length; d++) g[d].onclick = h, g[d].onmouseover = h, g[d].onmouseout = h, g[d].onmousedown = h;
            S().onclick = function () {
            ...
            e.reverseButtons ? E.parentNode.insertBefore(V, E) : E.parentNode.insertBefore(E, V), v.previousWindowKeyDown = window.onkeydown, window.onkeydown = s, e.buttonsStyling && (E.style.borderLeftColor = e.confirmButtonColor, E.style.borderRightColor = e.confirmButtonColor), o.showLoading = o.enableLoading = function () {
                ...
                var e = y() || o.init(), t = e.style.display;
            ...
            for (d = 0; d < j.length; d++) {
                var D = l[j[d]], I = L(t, D);
                if (T = c(j[d])) {
                    for (var K in T.attributes) if (T.attributes.hasOwnProperty(K)) {
                        var R = T.attributes[K].name;
                        "type" !== R && "value" !== R && T.removeAttribute(R)
                    }
                    for (var Q in e.inputAttributes) T.setAttribute(Q, e.inputAttributes[Q])
                }
            ...
            switch (e.input) {
                ...
                case"file":
                    ...
                    break;
                case"range":
                    var Z = L(t, l.range), F = Z.querySelector("input"), J = Z.querySelector("output");
                ...
                case"radio":
                    ...
                    G.innerHTML = "", Y = function (t) {
                        for (var n in t) {
                            var o = 1, r = document.createElement("input"), i = document.createElement("label"),
                    ...
                    break;
                case"checkbox":
                    var X = L(t, l.checkbox), ee = c("checkbox");
            ...
            if ("select" !== e.input && "radio" !== e.input || (e.inputOptions instanceof Promise ? (o.showLoading(), e.inputOptions.then(function (e) {
                ...
                p = new MutationObserver(oe), p.observe(t, {childList: !0, characterData: !0, subtree: !0})
            }
        })
    }
    ...
    var r, i = "swal2-", a = function (e) {
        ...
        s = a(["success", "warning", "info", "question", "error"]), c = {
            title: "",
            text: "",
            html: "",
            type: null,
    ...
    var p, f = function (e, t) {
        ...
        return n
    }, v = {previousWindowKeyDown: null, previousActiveElement: null, previousBodyPadding: null}, h = function (e) {
    ...
    }, K = f({}, c), R = [], U = function (e) {
        var t = y();
        for (var n in e) c.hasOwnProperty(n) || "extraParams" === n || console.warn('SweetAlert2: Unknown parameter "' + n + '"');
        t.style.width = "number" == typeof e.width ? e.width + "px" : e.width, t.style.padding = e.padding + "px", t.style.background = e.background;
        var o = t.querySelector("h2"), r = t.querySelector("." + l.content), i = C(), a = k(),
            u = t.querySelector("." + l.close);
        o.innerHTML = e.title.split("\n").join("<br>");
        var d;
        if (e.text || e.html) {
            if ("object" == typeof e.html) if (r.innerHTML = "", 0 in e.html) for (d = 0; d in e.html; d++) r.appendChild(e.html[d].cloneNode(!0)); else r.appendChild(e.html.cloneNode(!0)); else r.innerHTML = e.html || e.text.split("\n").join("<br>");
            q(r)
        } else M(r);
        e.showCloseButton ? q(u) : M(u), t.className = l.modal, e.customClass && P(t, e.customClass);
        var p = w(), f = parseInt(null === e.currentProgressStep ? swal.getQueueStep() : e.currentProgressStep, 10);
        ...
        var m = g();
        for (d = 0; d < m.length; d++) M(m[d]);
        if (e.type) {
            var v = !1;
            for (var h in s) if (e.type === h) {
                v = !0;
                break
            }
            if (!v) return console.error("SweetAlert2: Unknown alert type: " + e.type), !1;
    ...
    return o.isVisible = function () {
        ...
        if (!document.getElementsByClassName(l.container).length) {
            ...
            var e = y(), t = L(e, l.input), n = L(e, l.file), i = e.querySelector("." + l.range + " input"),
                a = L(e, l.select), s = e.querySelector("." + l.checkbox + " input"), c = L(e, l.textarea);
